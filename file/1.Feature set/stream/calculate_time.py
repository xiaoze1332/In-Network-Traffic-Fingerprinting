...
while(i < 31):
    ...
    location = "C:\\Users\\CYQ\\Desktop\\stream\\time\\" + str(i) + ".csv"
...
#df_mean.head()
loc = "C:\\Users\\CYQ\\Desktop\\stream\\time\\mean.csv"    #输出平均值到csv文件
df_mean.to_csv(loc,sep=",")

##STD##
df_STD = pd.DataFrame(STD)
#df_mean.head()
loc = "C:\\Users\\CYQ\\Desktop\\stream\\time\\STD.csv"    #输出平均值到csv文件
df_STD.to_csv(loc,sep=",")

##VAR##
df_VAR = pd.DataFrame(VAR)
#df_mean.head()
loc = "C:\\Users\\CYQ\\Desktop\\stream\\time\\VAR.csv"    #输出平均值到csv文件
