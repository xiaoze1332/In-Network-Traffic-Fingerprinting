...
while(i < 31):
    ...
    location = "C:\\Users\\CYQ\\Desktop\\stream\\size\\" + str(i) + ".csv"
...
#df_mean.head()
loc = "C:\\Users\\CYQ\\Desktop\\stream\\size\\mean.csv"    #输出平均值到csv文件
df_mean.to_csv(loc,sep=",")

##STD##
df_STD = pd.DataFrame(STD)
#df_mean.head()
loc = "C:\\Users\\CYQ\\Desktop\\stream\\size\\STD.csv"    #输出平均值到csv文件
df_STD.to_csv(loc,sep=",")

##VAR##
df_VAR = pd.DataFrame(VAR)
#df_mean.head()
loc = "C:\\Users\\CYQ\\Desktop\\stream\\size\\VAR.csv"    #输出平均值到csv文件
